...
export function ServicesView() {
  ...
  return (
    <div className="p-10 max-w-7xl mx-auto space-y-20 transition-colors">
      <Helmet>
        <title>Nexus Services | Micro-Service Provisioning</title>
        <meta name="description" content="Provision specialized Micro-Services into your physical environment. Standardized API endpoints for high-throughput sensor telemetry." />
      </Helmet>
